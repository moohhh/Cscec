...
const Navbar = () => {
  ...
  return (
    ...
    <>
      <div>
        <nav className='nav'>
          <img src={require('../images/cscec logo2.jpg')} alt="" className='logo' height={100} onClick={() => navigate('/accueilladmin')} />
          <ul>
            <li><a href=""> ressource humaine</a>
              <ul className='rh'>
                <li><a href="./demandeDocuments">demande document</a></li>
                <li><a href="./demandeconge">congé</a></li>
                <li><a href="./DemandeH">heure sup</a></li>
              </ul>
            ...
            <li> <a href="">moyens generaux</a>
              <ul className='rh'>
                ...
                <li><a href="./ConsomableU">consommable</a></li>
            ...
            <li>    <button className='connecter2' onClick={() => navigate('/profile')} >profile</button>
            </li>
          </ul>
        </nav>
